<?php /* Smarty version Smarty-3.1.11, created on 2014-09-03 20:31:22
         compiled from "modules/reviews/template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:137291148654074ef6226056-50834311%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60ccebff773d8c9b4e28c3114b9bb87af1f0667e' => 
    array (
      0 => 'modules/reviews/template.tpl',
      1 => 1409765478,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '137291148654074ef6226056-50834311',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_54074ef66d1848_19897546',
  'variables' => 
  array (
    'dirs' => 0,
    'module' => 0,
...
<?php if ($_valid && !is_callable('content_54074ef66d1848_19897546')) {function content_54074ef66d1848_19897546($_smarty_tpl) {?><link type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['dirs']->value['modules'];?>
...
<?php }?><?php } ?>&GVorderField=items_id&GVorderValue=<?php if (empty($_smarty_tpl->tpl_vars['TPL']->value['GETvars']['GVorderValue'])||$_smarty_tpl->tpl_vars['TPL']->value['GETvars']['GVorderValue']=='up'){?>down<?php }else{ ?>up<?php }?>"><?php echo $_smarty_tpl->tpl_vars['titles']->value['table_id'];?>
            ...
            <th style="width: 150px;"><?php echo $_smarty_tpl->tpl_vars['titles']->value['table_date'];?>
</th>
...
?><tr class="<?php if ($_smarty_tpl->getVariable('smarty')->value['section']['i']['iteration']%2==0){?>odd<?php }else{ ?>even<?php }?>">
            ...
            <td><?php echo $_smarty_tpl->tpl_vars['TPL']->value['items'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['items_review'];?>
</td>
            <td class="actions">
                <a class="ajax" href="<?php echo $_smarty_tpl->tpl_vars['TPL']->value['href'];?>
/reviewsDelItem/?id=<?php echo $_smarty_tpl->tpl_vars['TPL']->value['items'][$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']]['items_id'];?>
